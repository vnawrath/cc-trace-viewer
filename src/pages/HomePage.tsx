      ...
      <div className="bg-base-900 rounded-lg border border-base-800 p-8 shadow-lg">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/vnawrath/cc-trace-viewer"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-base-800 hover:bg-base-700 border border-base-700 rounded-lg text-text-secondary hover:text-text-primary transition-colors"
            >
